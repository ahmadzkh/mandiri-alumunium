...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    metaDescription:
      "Jasa aluminium di Bekasi — fabrikasi, pemasangan, dan service aluminium. Pintu, jendela, kusen, kitchen set, partisi. Pengalaman 15+ tahun.",
  },
  {
    slug: "jakarta",
    name: "Jakarta",
    ...
    metaDescription:
      "Jasa aluminium di Jakarta — fabrikasi, pemasangan, dan service aluminium. Pintu, jendela, kusen, partisi, etalase. Pengalaman 15+ tahun.",
  },
  {
    slug: "jabodetabek",
    name: "JABODETABEK",
    ...
    metaDescription:
      "Jasa aluminium di JABODETABEK — fabrikasi, pemasangan, dan service aluminium. Proyek rumah, toko, kantor, dan kontraktor. Pengalaman 15+ tahun.",
  },
]
